...
module BSV
  module Wallet
    ...
    class KeyDeriver
      ...
      #
      # This is the BRC-100 +getPublicKey+ emission value — pubkeys cross
      # BRC boundaries as hex by spec, so the canonical accessor returns
      # hex. Crypto-op consumers (hash160, ECDH input bytes) should use
