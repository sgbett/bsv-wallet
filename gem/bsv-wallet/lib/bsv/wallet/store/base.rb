...
module BSV
  module Wallet
    module Store
      # Shared orchestration for SQL-backed Interface::Store implementations.
      #
      # The 25 Interface::Store methods are identical business logic across
      # every SQL backend — the only thing that differs is which connection-
      # bound model classes they route to, and the semantics of
      # insert_conflict's return value.
      #
      ...
      #                        SQLite and Postgres differ in how they detect
      #                        a winning insert from insert_conflict.
      #
