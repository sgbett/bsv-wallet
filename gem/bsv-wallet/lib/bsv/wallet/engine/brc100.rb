...
module BSV
  module Wallet
    class Engine
      ...
      #
      # This module is a *slice of Engine*, not an island — it is included
      # into Engine and runs with +self+ as the engine instance. The moved
      # methods reach back to engine ivars (+@store+, +@key_deriver+,
      ...
      # and +Engine::BRC100+ on the Engine class, ancestry resolves as
      # +Engine → Engine::BRC100 → Interface::BRC100+ so impls always beat
