...
RSpec.describe BSV::Wallet::Store::Spendable, :store do
  ...
  let(:output) { BSV::Wallet::Store::Output.create(action_id: action.id, satoshis: 1000, vout: 0, locking_script: SecureRandom.random_bytes(25), output_type: 'root') }
