...
RSpec.describe BSV::Wallet::Store::Models::Input, :store do
  ...
  let(:spending_action) { BSV::Wallet::Store::Models::Action.create(description: 'test action', nlocktime: 0) }
  ...
  describe 'structural lock' do
    ...
    it 'prevents double-spend via UNIQUE on output_id' do
      ...
      other_action = BSV::Wallet::Store::Models::Action.create(description: 'test action', nlocktime: 0)
