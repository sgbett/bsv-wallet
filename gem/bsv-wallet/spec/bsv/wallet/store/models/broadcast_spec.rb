...
RSpec.describe BSV::Wallet::Store::Models::Broadcast, :store do
  let(:action) { BSV::Wallet::Store::Models::Action.create(description: 'test action', nlocktime: 0, wtxid: SecureRandom.random_bytes(32), raw_tx: SecureRandom.random_bytes(100)) }
