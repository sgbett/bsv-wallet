...
RSpec.describe BSV::Wallet::Store::UTXOPool, :store do
  ...
  describe '#select' do
    before do
      ...
      create_funded_output(satoshis: 300)
      create_funded_output(satoshis: 200)
    end
  ...
  describe '#change_output_count' do
    it 'returns max_change_per_tx for a rich wallet with empty pool' do
      ...
      create_funded_output(satoshis: 1_000_000)
