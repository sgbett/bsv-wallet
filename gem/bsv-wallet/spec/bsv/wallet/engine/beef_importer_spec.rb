...
RSpec.describe BSV::Wallet::Engine::BeefImporter do
  ...
  describe '#import' do
    ...
    # HLR #516 Sub 2 — successful ingress marks the subject + walked
    # ancestors as +verified_via = 'spv'+ (persistent verification cache).
    # Non-atomic BEEF sibling entries not reached by the subject-rooted
    # walk stay uncached.
