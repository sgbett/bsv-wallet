    ...
    module Postgres
      module Store
        class Action < Sequel::Model
          ...
          many_to_one  :tx_proof, class: 'BSV::Wallet::Postgres::Store::TxProof'
          one_to_one   :broadcast_entry, class: 'BSV::Wallet::Postgres::Store::Broadcast', key: :action_id
          one_to_many  :outputs, class: 'BSV::Wallet::Postgres::Store::Output'
          one_to_many  :inputs, class: 'BSV::Wallet::Postgres::Store::Input'
          many_to_many :labels, class: 'BSV::Wallet::Postgres::Store::Label',
          ...
          def write!(response)
            ...
            proof_store = BSV::Wallet::Postgres::Store::ProofStore.new
