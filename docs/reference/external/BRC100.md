!!! info "Vendored upstream"
    Verbatim copy of [BRC-100](https://github.com/bsv-blockchain/BRCs/blob/master/wallet/0100.md) from [`bsv-blockchain/BRCs`](https://github.com/bsv-blockchain/BRCs), kept here for offline / version-pinned access. Edits in this file are not authoritative; the canonical home is upstream.
